                ...
                <div className="mt-6 pt-4 border-t">
                    ...
                    {post.attachments.map((att, index) => (
                        ...
                        <div className="flex flex-col overflow-hidden">
                           <span className="text-sm font-medium truncate" title={att.name}>{att.name}</span>
                           <span className="text-xs text-muted-foreground">({(att.size / (1024 * 1024)).toFixed(2)} MB)</span>
                        </div>
