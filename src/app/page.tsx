...
function DownloadAppSection() {
  return (
    <div className="w-full p-4 text-center bg-card border border-border rounded-lg shadow-sm sm:p-8 mt-12 md:mt-16 lg:mt-24">
      <h5 className="mb-2 text-3xl font-bold text-foreground">
        {SiteConfig.name} on the Go
      </h5>
      <p className="mb-5 text-base text-muted-foreground sm:text-lg">
        Stay connected with {SiteConfig.name} on your mobile device. Download the app today!
      </p>
      <div className="items-center justify-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4 rtl:space-x-reverse">
        <a
          href="#" // Replace with actual App Store link
          className="w-full sm:w-auto bg-primary hover:bg-primary/90 focus:ring-4 focus:outline-none focus:ring-ring text-primary-foreground rounded-lg inline-flex items-center justify-center px-4 py-2.5"
        >
          <svg
